...
Driver-level configuration of hardware GRO may be controlled using ethtool.
...
- Get hardware GRO capability of the VF device::
    ...
    pci/0000:06:00.0/2: type eth netdev enp6s0pf0vf1 flavour pcivf pfnum 0 vfnum 1
        function:
            hw_addr 00:00:00:00:00:00 rx-gro-hw enable

- Set hardware GRO capability of the VF device::

    $ devlink port function set pci/0000:06:00.0/2 rx-gro-hw disable
