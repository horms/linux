...
enum devlink_port_fn_attr_cap {
	...
	DEVLINK_PORT_FN_ATTR_CAP_HEADER_SPLIT_BIT,
	DEVLINK_PORT_FN_ATTR_CAP_RX_GRO_HW_BIT,
	DEVLINK_PORT_FN_ATTR_CAP_MAX_SF_BIT,
...
#define DEVLINK_PORT_FN_CAP_HEADER_SPLIT _BITUL(DEVLINK_PORT_FN_ATTR_CAP_HEADER_SPLIT_BIT)
#define DEVLINK_PORT_FN_CAP_RX_GRO_HW    _BITUL(DEVLINK_PORT_FN_ATTR_CAP_RX_GRO_HW_BIT)
#define DEVLINK_PORT_FN_CAP_MAX_SF       _BITUL(DEVLINK_PORT_FN_ATTR_CAP_MAX_SF_BIT)
